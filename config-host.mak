...
libs_softmmu=-lutil -lncurses     -lz -L$(BUILD_DIR)/dtc/libfdt -lfdt -lpixman-1  
ARCH=x86_64
...
VERSION=1.5.50
PKGVERSION=
SRC_PATH=/root/qemu/qemu-1.5.50
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/root/qemu/qemu-1.5.50/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
