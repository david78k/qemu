...
typedef enum {
    ...
    TRACE_VIRTIO_BLK_DATA_PLANE_COMPLETE_REQUEST,
    TRACE_VRING_SETUP,
    ...
    TRACE_USB_HOST_CLAIM_INTERFACES,
    TRACE_USB_HOST_CLAIM_INTERFACE,
    TRACE_USB_HOST_RELEASE_INTERFACES,
    ...
    TRACE_USB_HOST_URB_SUBMIT,
    TRACE_USB_HOST_URB_COMPLETE,
    TRACE_USB_HOST_URB_CANCELED,
    TRACE_USB_HOST_EP_SET_HALT,
    TRACE_USB_HOST_EP_CLEAR_HALT,
    TRACE_USB_HOST_ISO_START,
    TRACE_USB_HOST_ISO_STOP,
    TRACE_USB_HOST_ISO_OUT_OF_BUFS,
    TRACE_USB_HOST_ISO_MANY_URBS,
    TRACE_USB_HOST_RESET,
    TRACE_USB_HOST_AUTO_SCAN_ENABLED,
    TRACE_USB_HOST_AUTO_SCAN_DISABLED,
    TRACE_USB_HOST_CLAIM_PORT,
    TRACE_USB_HOST_PARSE_DEVICE,
    TRACE_USB_HOST_PARSE_CONFIG,
    TRACE_USB_HOST_PARSE_INTERFACE,
    TRACE_USB_HOST_PARSE_ENDPOINT,
    TRACE_USB_HOST_PARSE_UNKNOWN,
    ...
    TRACE_MEGASAS_IO_READ,
    TRACE_MEGASAS_IO_WRITE,
    TRACE_MEGASAS_IO_CONTINUE,
    TRACE_MEGASAS_IOVEC_MAP_FAILED,
    ...
    TRACE_MILKYMIST_SOFTUSB_MOUSE_EVENT,
    ...
    TRACE_ISCSI_AIO_WRITE16_CB,
    TRACE_ISCSI_AIO_WRITEV,
    TRACE_ISCSI_AIO_READ16_CB,
    TRACE_ISCSI_AIO_READV,
    ...
    TRACE_QEMU_SPICE_START,
    TRACE_QEMU_SPICE_STOP,
...
#define TRACE_MIRROR_COW_ENABLED 1
...
#define TRACE_VIRTIO_BLK_DATA_PLANE_COMPLETE_REQUEST_ENABLED 1
